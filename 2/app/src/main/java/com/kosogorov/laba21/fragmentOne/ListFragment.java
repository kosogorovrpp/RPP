package com.kosogorov.laba21.fragmentOne;
...
import com.kosogorov.laba21.R;
import com.kosogorov.laba21.RequestInterface;
import com.kosogorov.laba21.Technologies;
import com.kosogorov.laba21.fragmentTwo.ViewPagerFragment;
...
//        return manager.beginTransaction().replace(R.id.homeA,viewPagerFragment);
        return v;
    }
